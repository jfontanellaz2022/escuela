...
$arr_datos = $obj->getReporteInscripcion('94426705',2025);
...
$origen_codigo = $argumentos[2];


if ($origen_codigo=='email') {
    
} else {

}

// esto pasar a una clase reporte
