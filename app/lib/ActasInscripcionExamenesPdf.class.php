...
class ActasInscripcionExamenesPdf extends ActasPdf {
    ...
    public function formateaCantidades($cantidad) {
        if ($cantidad==0) return "NINGUNO";
            ...
            return "VEINTI" . formateaDigitos($cantidad-20);
        } else if ($cantidad>=31 || $cantidad>=39) {
            return "TREINTA Y " . formateaDigitos($cantidad-30);
        } else if ($cantidad>=41 || $cantidad>=49) {
            return "CUARENTA Y " . formateaDigitos($cantidad-30);
        } else if ($cantidad>=51 || $cantidad>=59) {
            return "CINCUENTA Y " . formateaDigitos($cantidad-30);
        };
