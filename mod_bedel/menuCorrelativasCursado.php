...
//************************************************************************************************ */
//************************************************************************************************ */
let entidad_nombre = "correlativasCursado";
let entidad_titulo1 = "CORRELATIVAS PARA CURSAR";
let entidad_titulo2 = "Correlativas para cursar";
let campo1 = "Id";
let campo2 = "Codigo";
...
function entidadVer(entidad_id){
    ...
    $.get(url,function(data) {
          ...
          $("#subtitulo_ver").html("Ver Correlativas para Cursar");
...
function entidadCrear(){
      ...
      $.get(url,function(data) {
            $("#resultado_accion").html("");
            $("#principal").slideDown("slow").html(data);
            $("#subtitulo_formulario").html("Crear correlativa para cursar");
