...
$carrera = isset($_POST['carrera'])?SanitizeVars::APELLIDONOMBRES($_POST['carrera']):false;
$materia = isset($_POST['materia'])?SanitizeVars::APELLIDONOMBRES($_POST['materia']):false;
$anio = isset($_POST['anio'])?SanitizeVars::INT($_POST['anio']):false;
$cursado_id = isset($_POST['cursado_id'])?SanitizeVars::INT($_POST['cursado_id']):false;
$promocionable = isset($_POST['promocionable'])?SanitizeVars::STRING($_POST['promocionable'],1,1):false;
$formato_id = isset($_POST['formato_id'])?SanitizeVars::INT($_POST['formato_id']):false;
