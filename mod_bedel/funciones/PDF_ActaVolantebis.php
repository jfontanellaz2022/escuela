...
foreach ($ARRAY_ALUMNOS_RINDEN_MATERIA as $item) {
   ...
   /* $pdf->Cell(15,5,$i,1,0,'C',false);
    ...
    $pdf->Cell(42,7,'$ '.$imp_personal_1,1,0,'C',1);
    $pdf->SetX(59);
    $pdf->SetFillColor(220,220,220);
    $pdf->Cell(42,7,'$ '.$imp_patronal_1,1,0,'C',1);
    $pdf->SetX(103);
    $pdf->SetFillColor(220,220,220);
    $pdf->Cell(40,7,'$ '.$imp_otros_1,1,0,'C',1);
    $pdf->SetX(145);
    $pdf->SetFillColor(220,220,220);
    $pdf->Cell(50,7,'$ '.$imp_total_1,1,1,'C',1);*/
    // ACA FINALIZAN LOS BOX
